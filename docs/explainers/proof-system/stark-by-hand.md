...
> When the RISC Zero [zkVM](../zkvm/zkvm_overview.md) executes, it generates a [receipt](https://docs.rs/risc0-zkvm/latest/risc0_zkvm/receipt/) that allows third-parties to authenticate the validity of the execution. 
> The receipt contains a [zk-STARK](../../reference-docs/about-starks.md) in the form of the [seal](https://docs.rs/risc0-zkvm/latest/risc0_zkvm/receipt/struct.SegmentReceipt.html#structfield.seal). 
