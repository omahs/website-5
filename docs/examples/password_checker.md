...
* The guest program generates a salted hash of Alice's password and commits it to a `journal`, part of a computational [`receipt`](https://docs.rs/risc0-zkvm/latest/risc0_zkvm/receipt/).
